   <table class="menu">
    <tr>
     <td onmouseover="setBackGrdColor(this, 'mouseover');" onmouseout="setBackGrdColor(this, 'mouseout');">
      <a href="{$rewriter->get_page_url('Overview')}"><img src="{$icon_home}" />&nbsp;Overview</a>
     </td>
     <td onmouseover="setBackGrdColor(this, 'mouseover');" onmouseout="setBackGrdColor(this, 'mouseout');">
      <a href="{$rewriter->get_page_url('Manage')}" /><img src="{$icon_arrow_left}" />&nbsp;Manage</a>
     </td>
     <td onmouseover="setBackGrdColor(this, 'mouseover');" onmouseout="setBackGrdColor(this, 'mouseout');">
     ...
     <td onmouseover="setBackGrdColor(this, 'mouseover');" onmouseout="setBackGrdColor(this, 'mouseout');">
      <a href="{$rewriter->get_page_url('Others')}" /><img src="{$icon_arrow_right}" />&nbsp;Others</a>
     </td>
    </tr> 
   </table>
