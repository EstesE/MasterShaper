...
class FiltersView extends DefaultView
{
    ...
    public function showList()
    {
        ...
        $tmpl->registerPlugin("block", "filter_list", array(&$this, "smartyFilterList"));
    ...
    public function showEdit()
    {
        ...
        $tmpl->registerPlugin("function", "l7_select_list", array(&$this, "smartyL7SelectList"), false);
    ...
    public function store()
    {
        ...
        if (isset($_POST['filter_ipt'])) {
            $_POST['filter_time_start'] = strtotime(
                sprintf(
            ...
            $_POST['filter_time_stop'] = strtotime(
                sprintf(
                    "%04d-%02d-%02d %02d:%02d:00",
    ...
    } // smartyPortSelectList()

    public function smartyL7SelectList($params, &$smarty)
    {
        if (!array_key_exists('filter_idx', $params)) {
            $tmpl->trigger_error("getSLList: missing 'filter_idx' parameter", E_USER_WARNING);
            $repeat = false;
