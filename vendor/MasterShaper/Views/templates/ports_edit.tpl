...
<form class="thallium ui form" method="POST" data-id="{$port->getId()}" data-guid="{$port->getGuid()}" data-model="port" data-url-next="{get_url page='ports'}" data-url-discard="{get_url page='ports'}">
