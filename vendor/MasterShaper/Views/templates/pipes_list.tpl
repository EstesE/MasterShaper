...
{pipes_list}
 <tr>
  ...
  <td>
   <div name="pipe_{$item->getIdx()}" class="filterable inline editable content" data-current-value="{$item->getName()}" data-orig-value="{$item->getName()}" style="float: left;">{$item->getName()}</div>&nbsp;
   <a name="pipe_{$item->getIdx()}" class="inline editable edit link" data-inline-name="pipe_{$item->getIdx()}"><i class="tiny edit icon"></i></a>
   <div name="pipe_{$item->getIdx()}" class="inline editable formsrc" style="display: none;">
    <form class="ui form" onsubmit="return false;">
     <div class="fields">
      <div class="field small ui input">
       <input type="text" name="pipe_{$item->getIdx()}" value="{$item->getName()}" data-action="update" data-model="pipe" data-key="pipe_name" data-id="{$item->getIdx()}" />
      </div>
      <div class="field">
