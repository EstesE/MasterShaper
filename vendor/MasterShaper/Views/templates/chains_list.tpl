...
<table style="width: 100%;" class="withborder">
 <tr>
  <td colspan="5" style="text-align: center;">
   ...
   <a href="{get_url page='Chain New'}" title="Create a new Chain">Create a new Chain</a>
  </td>
 </tr>
 <tr>
  <td colspan="5">&nbsp;</td>
 ...
 <tr onmouseover="setBackGrdColor(this, 'mouseover');" onmouseout="setBackGrdColor(this, 'mouseout');">
  <td>
   ...
   <a href="{get_url page='Chain Edit' id=$chain_idx}" title="Click to modify">{$chain_name}</a>
  </td>
  <td>
   <img src="{$icon_servicelevels}" alt="servicelevel icon" />
  {if $chain_sl_idx != 0}
   <a href="{get_url page='Service Level Edit' id=$chain_sl_idx)}">{$chain_sl_name}</a>
  {else}
   {$chain_sl_name}
  {/if}
  </td>
  ...
  {if $chain_sl_idx != 0 && $chain_fallback_idx != 0}
   <a href="{get_url page='Service Level Edit' id=$chain_fallback_idx}">{$chain_fallback_name}</a>
  {else}
   {$chain_fallback_name}
  {/if}
  </td>
  <td>
   ...
   <a href="{get_url page='Network Path Edit' id=$chain_netpath_idx}">{$chain_netpath_name}</a>
  </td>
