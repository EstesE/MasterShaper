...
{network_interfaces_list}
 <tr>
  ...
  <td>
   <div name="interface_{$item->getId()}" class="filterable inline editable content" data-current-value="{$item->getName()}" data-orig-value="{$item->getName()}" style="float: left;">{$item->getName()}</div>&nbsp;
   <a name="interface_{$item->getId()}" class="inline editable edit link" data-inline-name="interface_{$item->getId()}"><i class="tiny edit icon"></i></a>
   <div name="interface_{$item->getId()}" class="inline editable formsrc" style="display: none;">
    <form class="ui form" onsubmit="return false;">
     <div class="fields">
      <div class="field small ui input">
       <input type="text" name="interface_{$item->getId()}" value="{$item->getName()}" data-action="update" data-model="network_interface" data-key="if_name" data-id="{$item->getId()}" />
      </div>
      <div class="field">
