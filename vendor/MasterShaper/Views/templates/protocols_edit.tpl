...
<form class="ui form" data-id="{$protocol->getId()}" data-guid="{$protocol->getGuid()}" data-model="protocol">
...
$(document).ready(function () {
   ...
   $('.ui.button.discard').click(function () {
      location.href = '{get_url page='protocols'}';
   });
   ...
   $('.ui.form').submit(function () {
      ...
      if (!(input = $(this).find('input[name^="proto_"], textarea[name^="proto_"]'))) {
