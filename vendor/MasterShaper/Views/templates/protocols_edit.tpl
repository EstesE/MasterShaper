...
<form class="thallium ui form" method="POST" data-id="{$protocol->getIdx()}" data-guid="{$protocol->getGuid()}" data-model="protocol" data-url-next="{get_url page='protocols'}" data-url-discard="{get_url page='protocols'}">
...
<p class="footnote">
 {include file="link_list.tpl" link_source=$protocol}
</p>
