...
{if !isset($user->user_idx) || empty($user->user_idx)}
...
<table style="width: 100%;" class="withborder">
 ...
 <tr>
  ...
  <td>
   <input type="password" name="user_pass1" size="30" value="{if !isset($new) || empty($new)} nochangeMS {/if}" />
  </td>
  <td>
 ...
 <tr>
  ...
  <td>
   <input type="password" name="user_pass2" size="30" value="{if !isset($new) || empty($new)} nochangeMS {/if}" />
  </td>
  <td>
   &nbsp;
  </td>
