...
<form class="thallium ui form" method="POST" data-id="{$user->getId()}" data-guid="{$user->getGuid()}" data-model="user" data-url-next="{get_url page='users'}" data-url-discard="{get_url page='users'}">
