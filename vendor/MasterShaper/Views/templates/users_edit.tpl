...
<form class="thallium ui form" data-id="{$user->getId()}" data-guid="{$user->getGuid()}" data-model="user" method="POST" data-url-next="{get_url page='users'}" data-url-discard="{get_url page='users'}">
