...
<form class="thallium ui form" method="POST" data-id="{$netpath->getIdx()}" data-guid="{$netpath->getGuid()}" data-model="network_path" data-url-next="{get_url page='network-paths'}" data-url-discard="{get_url page='network-paths'}">
