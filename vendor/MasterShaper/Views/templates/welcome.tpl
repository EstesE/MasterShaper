...
<ul>5. Create <img src="{$icon_pipes}" alt="pipe icon" />&nbsp;<a href="{get_url page='pipes'}" title="List Pipes">Pipes</a> and assign <img src="{$icon_filters}" alt="filter icon" />&nbsp;<a href="{get_url page='filters'}" title="List Filters">Filters</a> to it to channelize your traffic.</ul>
<ul>6. Create <img src="{$icon_chains}" alt="chain icon" />&nbsp;<a href="{get_url page='chains'}" title="List Chains">Chains</a>, assign <img src="{$icon_pipes}" alt="pipe icon" />&nbsp;<a href="{get_url page='pipes'}" title="List Pipes">Pipes</a> to it and attach it to a <img src="{$icon_interfaces}" alt="network path icon" />&nbsp;<a href="{get_url page='network-paths'}" title="List Network Paths">Network Path</a></ul>
<ul>7. Go and <img src="{$icon_rules_load}" alt="rules icon" />&nbsp;<a href="{get_url page='rules' mode='load'}" title="Load Ruleset">load</a> your ruleset!</ul>
</div>
