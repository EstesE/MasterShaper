...
<form class="thallium ui form" method="POST" data-id="{$servicelevel->getIdx()}" data-guid="{$servicelevel->getGuid()}" data-model="service_level" data-url-next="{get_url page='service-levels'}" data-url-discard="{get_url page='service-levels'}">
...
<p class="footnote">
 {include file="link_list.tpl" link_source=$servicelevel}
</p>
