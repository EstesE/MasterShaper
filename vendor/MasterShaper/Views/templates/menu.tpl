...
<div class="main_menu">
 ...
 <table class="rootVoice">
  <tr>
   <td onmouseover="setBackGrdColor(this, 'mouseover');" onmouseout="setBackGrdColor(this, 'mouseout');" class="rootVoice {literal}{menu: 'empty'}{/literal}" onclick="location.href='{get_url page='Overview'}';">
...
<div id="menu_manage" class="menu">
 <li>
  <a class="{ldelim}action: 'location.href=\'{get_url page='Chains List'}\''{rdelim}">
   <img src="{$icon_chains}" />&nbsp;Chains<br />
   <div class="menu_help">add, modify and delete chains</div>
  </a>
 </li>
 <li>
  <a class="{ldelim}action: 'location.href=\'{get_url page='Filters List'}\''{rdelim}">
   <img src="{$icon_filters}" />&nbsp;Filters<br />
   <div class="menu_help">add, modify and delete filters</div>
  </a>
 </li>
 <li>
  <a class="{ldelim}action: 'location.href=\'{get_url page='Pipes List'}\''{rdelim}">
...
<div id="menu_monitoring" class="menu">
 <li>
  <a class="{ldelim}action: 'location.href=\'{get_url page='Monitoring Chains'}\''{rdelim}">
   <img src="{$icon_chains}" />&nbsp;Chains<br />
   <div class="menu_help">bandwidth usage by all chains</div>
  </a>
 </li>
 <li>
  <a class="{ldelim}action: 'location.href=\'{get_url page='Monitoring Pipes'}\''{rdelim}">
   <img src="{$icon_pipes}" />&nbsp;Pipes<br />
   <div class="menu_help">bandwidth usage per chain</div>
  </a>
 </li>
 <li>
  <a class="{ldelim}action: 'location.href=\'{get_url page='Monitoring Bandwidth'}\''{rdelim}">
...
<div id="menu_others" class="menu">
 <li>
  <a class="{ldelim}action: 'location.href=\'{get_url page='Others Update IANA'}\''{rdelim}">
 ...
 <li>
  <a class="{ldelim}action: 'location.href=\'{get_url page='Others Update L7'}\''{rdelim}">
 ...
 <li>
  <a class="{ldelim}action: 'location.href=\'{get_url page='Others About'}\''{rdelim}">
